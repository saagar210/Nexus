...
- **Request Building**: Comprehensive editor for headers, query parameters, body (JSON/Text/Form-urlencoded)
...
- **Testing**: Vitest, Vue Test Utils (84 tests)
